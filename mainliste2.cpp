...
*/
		...
		score = maximum; //le score final de la protéine correspond au maximum global trouvé
		scoresvect[k] = score; //on stock ce score dans un vecteur qui contiendra les scores de toutes les protéines de la database
	...
	int k = 0;
	for(int iota=0;iota<10;iota++){ //on va chercher les 10 meilleurs scores dans le vecteur contenant ceux-ci
